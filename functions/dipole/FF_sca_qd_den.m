...
function FF_sca_qd_den(exc_CL, bem, Double_en, d_length, ene, enei, p, spec, spec_s, shift_l, op, dip_d)
    multiWaitbar( 'Far-field spectra enhancement', 0, 'Color', 'g', 'CanCancel', 'on' ); %  Loop over wavelengths 
    ...
    for j=1:3
        for ien = 1 : length( enei )
            ...
            multiWaitbar( 'Far-field spectra enhancement', ien / numel( enei ));
