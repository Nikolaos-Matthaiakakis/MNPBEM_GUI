...
function [bem, exc, exc_CL, exc_CL_M, exc_EELS_M]= BEMSolver(p, op, pw_pol, imp,impact,imp_spec, width, vel, Source_op, dip_p, dip_d, d_range2a,jones_pw,dir_pw)
    ...
    elseif Source_op==2 % Laser    
        ...
        elseif pw_pol==3
            exc_CL=planewave( [ jones_pw(1), jones_pw(2), jones_pw(3) ], [ dir_pw(1), dir_pw(2), dir_pw(3)], op ); %  s pol
        elseif pw_pol==4
